...
public class CertificationaskActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_certificationask);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_certyficationask, container, false);


            ListView resultsListView = (ListView) rootView.findViewById(R.id.ListView_key_generate_certyfiaction);
        ...
        public void onAttach(Activity activity) {
            ...
            ((CertificationaskActivity) activity).onSectionAttached(
