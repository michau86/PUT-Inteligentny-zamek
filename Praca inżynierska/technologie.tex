...
\begin{itemize*}
	\item język programowania Python w wersji 2.7.13\cite{Pyt} wraz z bibliotekami PyCrypto\footnote{ jest to biblioteka udostępniająca funkcje kryptograficzne}, MySQL-db\footnote{ jest to interfejs oferujący API do bazy MySQl  } oraz BlueZ \footnote{Biblioteka ułatwiająca zarządzanie modułem Bluetooth  },
...
\newpage
\subsection[Aplikacja serwera i baza danych]{Aplikacja serwera i baza danych [Maciej Marciniak]}
