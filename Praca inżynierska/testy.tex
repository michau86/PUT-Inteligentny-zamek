...
\begin{figure}[ht!]
	...
	\begin{minipage}{0.69\textwidth}
		...
		\caption{Stan początkowy testu zliczania osób (strona internetowa}
		\label{rys:Strona1}
	\end{minipage}
	\end{figure}
	...
	\begin{minipage}{0.69\textwidth}
		...
		\caption{Stan po ''wejściu'' osoby (strona internetowa)}
		\label{rys:Strona2}
	\end{minipage}
	\hspace{0.01\textwidth}
	\begin{minipage}{0.3\textwidth}
		\includegraphics[width=0.9\textwidth]{Obrazy/Kamera2}
		\caption{Stan po ''wejściu'' osoby (urządzenie sterujące)}
		\label{rys:Kamera2}
	\end{minipage}
\end{figure}
	...
	\begin{figure}[ht!]
		...
		\caption{Stan po ''wyjściu'' osoby (urządzenie sterujące)}
		\label{rys:Kamera3}
	\end{figure}
\newpage
	\item Symulacja otwarcia
	...
	\item uzyskanie dostępu do zamka (aktywacja bluetooth)
