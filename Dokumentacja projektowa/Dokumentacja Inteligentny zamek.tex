...
\begin{document}
	...
	\begin{itemize*}
		...
		\item zainstalowany interpreter jêzyka Python 2.7 z pakietem bibliotek (RSA, Bluetooth, Lightblue, RPi.GPIO),
...
\newpage
	...
	\item zainstalowany interpreter jêzyka Python 2.7 wraz z pakietem bibliotek (MySQl, RSA, Django),
