...
\begin{document}
	...
	\begin{itemize*}
		...
		\item zainstalowany interpreter jêzyka Python 2.7 z pakietem bibliotek (RSA, Bluetooth, Lightblue, RPi.GPIO, SHA3),
...
\newpage
	...
	\item zainstalowany interpreter jêzyka Python 2.7 wraz z pakietem bibliotek (MySQl, RSA, Django, SHA3),
...
\chapter{Diagramy Klas}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width=25cm]{Obrazy/Diagram_klas_aplikacja_serwerowa.png}
