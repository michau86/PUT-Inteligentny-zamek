...
\chapter{Podsumowanie projektu}
	Projekt nie zosta³ w pe³ni zrealizowany wed³ug zak³adanej dokumentacji. Du¿ym problemem okaza³o siê generowanie certyfikatu dla goœci. Tworz¹c dostêp trudno by³o utworzyæ parê kluczy prywatny --- publiczny, tak aby ka¿dy u¿ytkownik mia³ inny, a przy tym nie narusza³ bezpieczeñstwa kluczy twórcy dostêpu. Zosta³ zastosowany w takim wypadku uniwersalny klucz dla goœci, to znaczy ka¿dy z nich ma taki sam klucz. Jest to zagro¿enie dla systemu o tyle, ¿e nie jest w stanie potwierdziæ kto faktycznie wys³a³ dany certyfikat.
