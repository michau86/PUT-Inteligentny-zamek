...
\end{minipage}	
	...
	\item ,,Lista oczekuj¹cych u¿ytkowników na rejestracjê'',
	\item ,,Lista oczekuj¹cych certyfikatów na akceptacjê''.
	\end{itemize*}
	...
	\begin{SCfigure}[][h]
			\includegraphics[width=6cm]{Obrazy/generowanie_nowego_klucza_uzytkownik_zalogowany_admin_pioniowo}
	...
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=9.1cm]{Obrazy/lista_certyfikatow_administrator_poziomo}
	...
	\section{Panel~listy~oczekuj¹cych~certyfikatów~na~akceptacjê}
	\begin{wrapfigure}[5]{R}{4.5cm}
		\vspace{-1cm}
