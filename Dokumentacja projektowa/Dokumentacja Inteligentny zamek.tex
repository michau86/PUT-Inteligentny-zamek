...
\newpage
	...
	\begin{wrapfigure}[5]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/logowanie_uzytkownika_pionowo}
	...
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=10cm]{Obrazy/logowanie_uzytkownika_poziomo}
...
\newpage
	...
	\begin{wrapfigure}[6]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/rejestracja_uzytkownika_pionowo}
		\caption{Panel logowania u¿ytkownika (pionowo)}
	...
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=10cm]{Obrazy/rejestracja_uzytkownika_poziomo}
			\caption{Panel logowania u¿ytkownika (poziomo)}
	...
	\begin{wrapfigure}[5]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/panel_boczny_pionowo}
	...
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
	\includegraphics[width=10cm]{Obrazy/panel_boczny_poziomo}
...
\end{minipage}	
	...
	\begin{wrapfigure}[6]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/zarzadzaj_certyfikatami_pionowo}
	...
	\begin{figure}[h]
			\begin{minipage}{9.5cm}
		\includegraphics[width=10.1cm]{Obrazy/zarzadzaj_certyfikatami_poziomo}
	...
	\section{Panel listy certyfikatów}
		...
		\vspace{-1.5cm}
		\includegraphics[width=5.5cm]{Obrazy/lista_certyfikatow_pionowo}
	...
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=10.3cm]{Obrazy/lista_certyfikatow_poziomo}
	...
	\section{Panel certyfikatu}
		\begin{wrapfigure}[5]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/certyfikat_pionowo}
	...
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=10.3cm]{Obrazy/certyfikat_poziomo}
	...
	\begin{wrapfigure}[3]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/wnioskuj_o_certyfikat_pionowo}
	...
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=10cm]{Obrazy/wnioskuj_o_certyfikat_poziomo}
	...
	\begin{wrapfigure}[5]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/generowanie_nowego_klucza_goscia_pionowo}
		\caption{Panel tworzenia certyfikatu dla goœcia (pionowo)}
		\label{rys:generowanie_nowego_klucza_goscia_pionowo}
	\end{wrapfigure}
	
	Panel tworzenia certyfikatu goœcia sk³ada siê z danych goœcia (imiê i nazwisko), daty od której obowi¹zuje certyfikat, zamka którego dotyczy oraz jak d³ugo pozostanie wa¿ny (wybór z rozwijanej listy). Aby zakoñczyæ proces generowania nale¿y klikn¹æ przycisk “WYGENERUJ”. (Rysunek \ref{rys:generowanie_nowego_klucza_goscia_pionowo} i \ref{rys:generowanie_nowego_klucza_goscia_poziomo})
	
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=10cm]{Obrazy/generowanie_nowego_klucza_goscia_poziomo}
			\caption{Panel tworzenia certyfikatu dla goœcia (poziomo)}
			\label{rys:generowanie_nowego_klucza_goscia_poziomo}	
		\end{minipage}
	\end{figure}
	...
	\begin{wrapfigure}[8]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/panel_administracyjny_pionowo}
		\caption{Panel administratora (pionowo)}
		\label{rys:panel_administracyjny_pionowo}
	\end{wrapfigure}
	
	W panelu administratora znajduj¹ siê 4 przyciski do administrowania systemem zamków:
	\begin{itemize*}
	\item ,,Historia u¿ycia Zamków''
	\item ,,Generowanie nowego klucza'',
	\item ,,Zarz¹dzanie kluczami u¿ytkowników'',
	\item ,,Lista oczekuj¹cych u¿ytkowników'',
	\item ,,Lista oczekuj¹cych certyfikatów''.
	\end{itemize*}
	...
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=6cm]{Obrazy/panel_administracyjny_poziomo}
	...
	\section{Panel historii u¿ycia zamków}
		\begin{wrapfigure}[5]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/historia_zamkow_pionowo}
		\caption{Panel historii u¿ycia zamków (pionowo)}
		\label{rys:panel_historii_uzycia_zamka_pionowo}
	\end{wrapfigure}
	
	Panel historii u¿ycia zamków sk³ada siê z rozwijanej listy wszystkich zamków znaj¹cych siê w systemie, s³u¿¹cej do filtrowania wyników. Pozycje opisane kolorem czerwonym dotycz¹ operacji odrzucanych, bia³e przyznaj¹cych dostêp do zamka. (Rysunek \ref{rys:panel_historii_uzycia_zamka_pionowo} i \ref{rys:panel_historii_uzycia_zamka_poziomo})
	
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=10cm]{Obrazy/historia_zamkow_poziomo}
	...
	\begin{wrapfigure}[10]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/generowanie_nowego_klucza_gosc_admin_pioniowo}
	...
	\begin{SCfigure}[][h]
			\includegraphics[width=6.5cm]{Obrazy/generowanie_nowego_klucza_uzytkownik_zalogowany_admin_pioniowo}
	...
	\begin{wrapfigure}[6]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=4.5cm]{Obrazy/dodaj_typ_dostepu_pionowo}
		\caption{Panel dodawania nowego typu dostêpu (pionowo)}
		\label{rys:panel_dodaj_typ_dostepu_pionowo}
	\end{wrapfigure}
	
	Panel dodawania typu dostêpu s³u¿y do dodania nowego rodzaju dostêpu. Administrator wybiera dni tygodnia w których ma obowi¹zywaæ typ, nastêpnie godzinê od do dla danych dni. Na koniec podaje unikaln¹ nazwê i klika “DODAJ” w celu zakoñczenia dodawania lub “ANULUJ”, aby usun¹æ wprowadzone zmiany. (Rysunek \ref{rys:panel_dodaj_typ_dostepu_pionowo} i \ref{rys:panel_dodaj_typ_dostepu_poziomo} )
	
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=7cm]{Obrazy/dodaj_typ_dostepu_poziomo}
			\caption{Panel dodawania nowego typu dostêpu (poziomo)}
			\label{rys:panel_dodaj_typ_dostepu_poziomo}	
		\end{minipage}
	\end{figure}
	...
	\begin{wrapfigure}[5]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/lista_certyfikatow_administrator_pionowo}
		\caption{Panel zarz¹dzania certyfikatami (administrator) (pionowo)}
		\label{rys:panel_lista_certyfikatow_administrator_pionowo}
	\end{wrapfigure}
	
	Panel zarz¹dzania certyfikatami u¿ytkowników (administrator) jest widokiem tylko wszystkich aktywnych certyfikatów w systemie. Administrator klikaj¹c na pozycjê przechodzi do panelu certyfikatu opisanego wy¿ej. Tam mo¿e usun¹æ dostêp lub go przed³u¿yæ. (Rysunek \ref{rys:panel_lista_certyfikatow_administrator_pionowo} i \ref{rys:panel_lista_certyfikatow_administrator_poziomo})
	
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=10cm]{Obrazy/lista_certyfikatow_administrator_poziomo}
	...
	\begin{wrapfigure}[5]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/lista_oczekujacych_uzytkownikow_pionowo}
	...
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=10cm]{Obrazy/lista_oczekujacych_uzytkownikow_poziomo}
	...
	\begin{wrapfigure}[5]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/lista_oczekujacych_certyfikatow_pionowo}
	...
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=10cm]{Obrazy/lista_oczekujacych_certyfikatow_poziomo}
	...
	\begin{wrapfigure}[5]{R}{4.5cm}
		\vspace{-1cm}
		\includegraphics[width=5.5cm]{Obrazy/ustawienia_pionowo}
	...
	\begin{figure}[h]
		\begin{minipage}{9.5cm}
			\includegraphics[width=10cm]{Obrazy/ustawienia_poziomo}
