...
urlpatterns = [
    ...
    url(r'^api/admin/generate_new_certificate/$', views.api_admin_generate_new_certificate,
        name='api_admin_generate_new_certificate'),

    url(r'^api/admin/download/all_certificate/$', views.api_admin_download_all_certificate,
        name='api_admin_download_all_certificate'),
    ...
    url(r'^api/admin/certificate_decision/$', views.api_admin_cetificate_decision,
        name='api_admin_certificate_decision'),
    ...
    url(r'^api/admin/deactivation_user_accout/$', views.api_admin_deactivation_user_account,
        name='api_admin_deactivation_user_account'),
